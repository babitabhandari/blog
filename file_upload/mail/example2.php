...
//});
 ...
 <script>
   $(document).ready(function(){
if($('#enew').attr('checked')){
  $("#eupload").attr("disabled", true);
$("#epending").attr("disabled", true);

 }
if($('#epending').attr('checked')){
  $("#eupload").attr("disabled", true);
$("#enew").attr("disabled", true);
...
<table class="table table-bordered">
    <thead>
      ...
      <tr>
        <th>Total No of emails Uploaded</th>
        <th><input type="checkbox" class="check" name="new" id="eupload" value="previous">Previous validated emails</th>
        <th><input type="checkbox" class="check" name="new" id="enew"  value="new1" <?php if (isset($_POST['newemail'])  == 'new1') { 
         ?> checked="checked" <?php } ?>>New  Emails are to be validated</th>
        <th><input type="checkbox" class="check" value="pending"  id="epending" name="new" <?php if (isset($_POST['expire'])  == 'pending') { 
         ?> checked="checked" <?php } ?>>Revalidate or Expired emails</th>
      </tr>
    </thead>
    <tbody>
      <tr>
...
echo $up1;
         ?>
          ...
          <input  type="submit" value="Export" name="export" style="background:#3F4C6B;opacity:1.4;color:white;display:none;" class="btn btn-primary export" >
        
        <input  type="submit" value="New Emails" name="newemail" style="background:#3F4C6B;opacity:1.4;color:white;display:none;" class="btn btn-primary newemail">
        <input  type="submit" value="Revalidate Emails"  name="expire" style="background:#3F4C6B;opacity:1.4;color:white;display:none;" class="btn btn-primary expire">
         <input   type="submit" value="Export" name="reexport" style="background:#3F4C6B;opacity:1.4;color:white;display:none;" class="btn btn-primary reval">
...
<h3>Email Validation</h3>
 ...
 <!--  <h4 style="color:red;">You Have Crossed your limit.Out of -->  <?php 
   ...
   //   $rec= tab_.$rec1;
     ...
     //echo $rec;
//   $rec_email=mysql_query("select email from tab_recruiter");
...
// echo $r;
 ...
 //    $rec1= ucwords($row['username']);  
//  //      $rec= tab_.$rec1;
//   $rec_email2=mysql_query("select email from tab_recruiter where status!='null'");
