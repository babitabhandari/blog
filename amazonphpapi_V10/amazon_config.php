...
define('SMALL_IMAGE_PROPERTIES','');

//  XSL live transform Amazon data to HTML
define('PRODUCT_DETAIL_URL','http://xml.amazon.com/onca/xml2?t='.ASSOCIATE_ID.'&dev-t='.DEVELOPER_TOKEN.'&type=heavy&f=http://www.php9.com/php9-data-to-htmls.xsl&AsinSearch=');

if (!isset($sCurrentMode) || $sCurrentMode != $_GET['Mode']) {
	$sCurrentMode = 'books';
}
...
if (!isset ($sCurrentModeSortType) || $sCurrentModeSortType != $_GET['SortBy']) {
...
$sUrl  = 'http://xml.amazon.com/onca/xml2';
$sUrl .= '?t='. ASSOCIATE_ID;
